...
static void mat2_println(mat2 matrix) {
    mat2_println_f(matrix, stdout);
}
...
static void mat3_println(mat3 matrix) {
    mat3_println_f(matrix, stdout);
}
...
static void mat4_println(mat4 matrix) {
    mat4_println_f(matrix, stdout);
}
