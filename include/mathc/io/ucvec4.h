#ifndef MATHC_IO_UCVEC4_H
#define MATHC_IO_UCVEC4_H
...
#define UCVEC4_PRINT_FORMAT "(ucvec4) {{  %" UCSCA_PRINT_FORMAT_SPECIFIER \
 ", %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER " }}"

#define UCVEC4_PRINT_FORMAT_COLORED "(ucvec4)" \
 MATHC_TERMINALCOLOR_CYAN " {{  %" UCSCA_PRINT_FORMAT_SPECIFIER \
 ", %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER " }}"\
 MATHC_TERMINALCOLOR_RESET

#define UCVEC4_PRINT_FORMAT_VALUES "%" UCSCA_PRINT_FORMAT_SPECIFIER \
 ", %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER
