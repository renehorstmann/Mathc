#ifndef MATHC_IO_UCVEC2_H
#define MATHC_IO_UCVEC2_H
...
#define UCVEC2_PRINT_FORMAT_COLORED "(ucvec2)"\
 MATHC_TERMINALCOLOR_CYAN " {{ %" UCSCA_PRINT_FORMAT_SPECIFIER ", %" UCSCA_PRINT_FORMAT_SPECIFIER " }}"\
