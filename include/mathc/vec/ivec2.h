...
/** returns the index of the min vec value */
static int ivec2_min_index_v(const int *vec) {
    return ivec2_min_index(IVec2(vec));
}
...
/** returns the index of the max vec value */
static int ivec2_max_index_v(const int *vec) {
    return ivec2_max_index(IVec2(vec));
}
...
/** returns dot(b-a) */
static float ivec2_sqr_distance(ivec2 vec_a, ivec2 vec_b) {
    return ivecN_sqr_distance(vec_a.v, vec_b.v, 2);
}

/** returns dot(b-a) */
static float ivec2_sqr_distance_v(const int *vec_a, const int *vec_b) {
    return ivec2_sqr_distance(IVec2(vec_a), IVec2(vec_b));
}
