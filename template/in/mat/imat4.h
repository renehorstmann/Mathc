...
/** imat[:][col] = v; dst = m */
static imat4 imat4_set_this_col(imat4 *imat, ivec4 v, int col) {
    imatN_set_col(imat->v, v.v, col, 4);
    return *imat;
}
...
/** dst = a @ b */
static imat4 imat4_mul_imat(imat4 a, imat4 b) {
    imat4 res;
    imatN_mul_imat_no_alias(res.v, a.v, b.v, 4);
    return res;
}
...
/** dst = a @ b */
static ivec4 ivec4_mul_imat(ivec4 a, imat4 b) {
    ivec4 res;
    ivecN_mul_imat_no_alias(res.v, a.v, b.v, 4);
    return res;
}
