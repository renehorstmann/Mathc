...
/** returns the index of the min vec value */
static int dvec4_min_index_v(const double *vec) {
    return dvec4_min_index(DVec4(vec));
}
...
/** returns the index of the max vec value */
static int dvec4_max_index_v(const double *vec) {
    return dvec4_max_index(DVec4(vec));
}
...
/** returns dot(b-a) */
static double dvec4_sqr_distance(dvec4 vec_a, dvec4 vec_b) {
    return dvecN_sqr_distance(vec_a.v, vec_b.v, 4);
}

/** returns dot(b-a) */
static double dvec4_sqr_distance_v(const double *vec_a, const double *vec_b) {
    return dvec4_sqr_distance(DVec4(vec_a), DVec4(vec_b));
}
