#ifndef MATHC_IO_IMAT3_H
#define MATHC_IO_IMAT3_H
...
#define IMAT3_PRINT_FORMAT "(imat3) {{"\
 "\n%12" ISCA_PRINT_FORMAT_SPECIFIER ", %" ISCA_PRINT_FORMAT_SPECIFIER ", %" ISCA_PRINT_FORMAT_SPECIFIER\
 ",\n%12" ISCA_PRINT_FORMAT_SPECIFIER ", %" ISCA_PRINT_FORMAT_SPECIFIER ", %" ISCA_PRINT_FORMAT_SPECIFIER\
 ",\n%12" ISCA_PRINT_FORMAT_SPECIFIER ", %" ISCA_PRINT_FORMAT_SPECIFIER ", %" ISCA_PRINT_FORMAT_SPECIFIER" }}"

#define IMAT3_PRINT_FORMAT_COLORED "(imat3)"\
