...
static int uvec4_min_index(uvec4 vec) {
    return uvecN_min_index(vec.v, 4);
}

/** returns the index of the min vec value */
static int uvec4_min_index_v(const unsigned *vec) {
    return uvec4_min_index(UVec4(vec));
}

/** returns the index of the max vec value */
static int uvec4_max_index(uvec4 vec) {
    return uvecN_max_index(vec.v, 4);
}

/** returns the index of the max vec value */
static int uvec4_max_index_v(const unsigned *vec) {
    return uvec4_max_index(UVec4(vec));
}
