...
/** returns the index of the min vec value */
static int ivec3_min_index_v(const int *vec) {
    return ivec3_min_index(IVec3(vec));
}
...
/** returns the index of the max vec value */
static int ivec3_max_index_v(const int *vec) {
    return ivec3_max_index(IVec3(vec));
}
...
/** returns dot(b-a) */
static float ivec3_sqr_distance(ivec3 vec_a, ivec3 vec_b) {
    return ivecN_sqr_distance(vec_a.v, vec_b.v, 3);
}

/** returns dot(b-a) */
static float ivec3_sqr_distance_v(const int *vec_a, const int *vec_b) {
    return ivec3_sqr_distance(IVec3(vec_a), IVec3(vec_b));
}
