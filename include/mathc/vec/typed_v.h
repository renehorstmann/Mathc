...
// 1. typed_v functions for float[3] as vec3f
// 2. typed_v functions for float[4] as vec4f
// 3. typed_v functions for double[3] as vec3d
// 4. typed_v functions for double[4] as vec4d
// 5. typed_v functions for int[3] as vec3i
// 6. typed_v functions for int[4] as vec4i
//
