...
/** m[:][col] = v; dst = m */
static imat3 imat3_set_this_col(imat3 *m, ivec3 v, int col) {
    imatN_set_col(m->v, v.v, col, 3);
    return *m;
}
...
/** m[row][:] = s; dst = m */
static imat3 imat3_set_this_row_sca_v(int *m, int s, int row) {
    return imat3_set_this_row_sca((imat3 *) m, s, row);
}
...
/** m[:][col] = s; dst = m */
static imat3 imat3_set_this_col_sca_v(int *m, int s, int col) {
    return imat3_set_this_col_sca((imat3 *) m, s, col);
}
...
/** dst = a @ b */
static imat3 imat3_mul_imat(imat3 a, imat3 b) {
    imat3 res;
    imatN_mul_imat_no_alias(res.v, a.v, b.v, 3);
    return res;
}
...
/** dst = a @ b */
static ivec3 ivec3_mul_imat(ivec3 a, imat3 b) {
    ivec3 res;
    ivecN_mul_imat_no_alias(res.v, a.v, b.v, 3);
    return res;
}
