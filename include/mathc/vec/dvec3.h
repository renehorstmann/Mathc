...
/** returns the index of the min vec value */
static int dvec3_min_index_v(const double *vec) {
    return dvec3_min_index(DVec3(vec));
}
...
/** returns the index of the max vec value */
static int dvec3_max_index_v(const double *vec) {
    return dvec3_max_index(DVec3(vec));
}
...
/** returns dot(b-a) */
static double dvec3_sqr_distance(dvec3 vec_a, dvec3 vec_b) {
    return dvecN_sqr_distance(vec_a.v, vec_b.v, 3);
}

/** returns dot(b-a) */
static double dvec3_sqr_distance_v(const double *vec_a, const double *vec_b) {
    return dvec3_sqr_distance(DVec3(vec_a), DVec3(vec_b));
}
