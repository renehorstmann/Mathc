...
/** returns the index of the min vec value */
static int ivec4_min_index_v(const int *vec) {
    return ivec4_min_index(IVec4(vec));
}
...
/** returns the index of the max vec value */
static int ivec4_max_index_v(const int *vec) {
    return ivec4_max_index(IVec4(vec));
}
...
/** returns dot(b-a) */
static float ivec4_sqr_distance(ivec4 vec_a, ivec4 vec_b) {
    return ivecN_sqr_distance(vec_a.v, vec_b.v, 4);
}

/** returns dot(b-a) */
static float ivec4_sqr_distance_v(const int *vec_a, const int *vec_b) {
    return ivec4_sqr_distance(IVec4(vec_a), IVec4(vec_b));
}
