...
static void
umatN_get_block(unsigned *restrict dst_block, const unsigned *restrict mat, int row, int col, unsigned block_n, int n) {
...
static void
umatN_set_block(unsigned *restrict dst_mat, const unsigned *restrict block, int row, int col, unsigned block_n, int n) {
    assert(row >= 0 && row + block_n <= n);
    assert(col >= 0 && col + block_n <= n);
    for (int c = 0; c < block_n; c++) {
        for (int r = 0; r < block_n; r++) {
